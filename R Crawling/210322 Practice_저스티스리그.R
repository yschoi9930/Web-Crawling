...
p_review <- read.csv('Final_저스티스리그.csv')
p_review
...
length(predict_2)
sum(predict_2 == score_fin[-train]) / length(predict_2) # 0.619863
...
length(predict_r2)
sum(predict_r2 == score_fin[-train]) / length(predict_r2) # 0.630137
